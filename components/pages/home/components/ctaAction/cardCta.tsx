import { Heart, Pen, Share, Users } from "lucide-react";
        ...
        <div className="inline-block mb-8 p-1 border-4 border-primary/30 relative">
          ...
          <div className="bg-card p-8 md:p-12">
            ...
            <div className="flex gap-4 items-center justify-center flex-col lg:flex-row">
              ...
              <Button className="bg-primary hover:bg-primary/90 text-primary-foreground font-vhs tracking-wider text-lg px-12">
                CRIAR MINHA CONTA
              </Button>
              <Button className="bg-primary hover:bg-primary/90 text-primary-foreground font-vhs tracking-wider text-lg px-12">
